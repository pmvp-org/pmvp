...
class StaticForeignKeyStorageTest {
    ...
    ): StaticForeignKeyStorage<Int, Int, Item>(items)
    ...
    fun testUpsert() = runBlockingTest {
        ...
        assertEquals(item1.name, actual.name)
    }
    ...
    fun testUpsertBatch() = runBlockingTest {
        ...
        assertNotNull(actual1)
        assertEquals(item1.name, actual1.name)
        assertNotNull(actual2)
        assertEquals(item2.name, actual2.name)
